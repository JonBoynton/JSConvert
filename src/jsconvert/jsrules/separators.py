'''jsconvert/jsrules/separators.py

Provides a set of code rules containing special heuristics for transpiling and
formatting of various separator characters for use (or omission) in javasrcipt
(ES6) source code.
...
from jsconvert.comp import ForCondition
...
__all__ = [
    "OpenBrace", "CloseBrace", "Semicolon", "Colon", "Commas", 
    "OpenParenthesis", "CloseParenthesis", "CloseExpression"]
...
# adds a token to the specified buffer if it matches internal criteria. returns the number entries consummed    
...
class Colon(CodeRule):
    def __init__(self):
        super().__init__("colon", ["Separator"])
